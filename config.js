...
export const AI = () => {
    return {
        type: "text",
        text: `🤖 AI Sakeezt Dev เริ่มการใช้งาน
ท่านสามารถพิมพ์ข้อมูลเกี่ยวกับ "การทักทาย" ได้เลยครับ `,
    }
...
export const contract = () => {
    return {
        type: "text",
        text: `ท่านสามารพิมพ์สอบถามข้อมูล
โดยติดต่อในเเชท Line OA นี้ได้เลยครับ`,
    }
